...
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(123,'Simon Bolivar', 'Kra11#9-56', '7702291', 'Cali', 'simon.bolivar@example.com', 'password123');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(456,'Mark Zuckerberg', 'Cll 21#95-52', '+57-315291', 'Medellin', 'mark.zuckerberg@example.com', 'password456');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(789,'Drew Barrymore', 'Kra52#65-05', '3125359456', 'Cali', 'drew.barrymore@example.com', 'password789');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(741,'Larry Page', 'Cll 05#52-95', '7872296', 'Tunja', 'larry.page@example.com', 'password741');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(147,'Tom Delonge', 'Cll 52#65-56', '7992293', 'Medellin', 'tom.delonge@example.com', 'password147');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(852,'Simon Bolivar', 'Kra 21#65-52', '982295', 'Bogota', 'simon.bolivar@example.com', 'password852');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(258,'Mark Hoppus', 'Cll 11#95-9', '8952294', 'Bogota', 'mark.hoppus@example.com', 'password258');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(963,'Britney Spears', 'Cll 05#52-56', '7705295', 'Tunja', 'britney.spears@example.com', 'password963');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(369,'John Forbes Nash', 'Kra 21#05-56', '776622966', 'Cali', 'john.nash@example.com', 'password369');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(159,'Tom Delonge', 'Kra05#65-05', '6702293', 'Medellin', 'tom.delonge@example.com', 'password159');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(753,'Sergey Brin', 'Cll 11#65-11', '9702299', 'Medellin', 'sergey.brin@example.com', 'password753');
INSERT INTO CLIENTE(id_cliente, nombre, direccion, telefono, ciudad, correo, contrasena) VALUES(153,'Emma Watson', 'Kra 9#9-95', '31569638', 'Tunja', 'emma.watson@example.com', 'password153');
...
INSERT INTO VENTA(cantidad, id_cliente, id_producto) VALUES(5, 456, 7);
INSERT INTO VENTA(cantidad, id_cliente, id_producto) VALUES(600, 741, 8);
INSERT INTO VENTA(cantidad, id_cliente, id_producto) VALUES(69, 852, 9);
INSERT INTO VENTA(cantidad, id_cliente, id_producto) VALUES(15, 789, 10);
